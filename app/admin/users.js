...
const styles = StyleSheet.create({
  ...
  table: { backgroundColor: '#FFFFFF', borderRadius: 14, borderWidth: 1, borderColor: '#E8E0D0', overflow: 'hidden', marginBottom: 16 },
  tableRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 11, paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: '#F5F0E8' },
  tableHead: { backgroundColor: '#F5F0E8', borderBottomColor: '#E8E0D0' },
  tableRowTap: { backgroundColor: '#FFFFFF' },
  tableRowSelected: { backgroundColor: 'rgba(69,53,75,0.05)' },
  ...
  idCell: { fontWeight: '700', color: '#1A1611', fontFamily: 'monospace', minWidth: 100 },
  nameCell: { flex: 2, fontWeight: '600', color: '#1A1611', minWidth: 140 },
